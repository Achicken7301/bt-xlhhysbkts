...
clear all;
clc;
addpath('..\Sample and Code demo'); %duong dan code cua thay
addpath('E:\Software\Matlab\Function')% duong dan chua cac code can dung
%% Load file
[path,filepath,name,ext]=Loadfile();
I=imread(path);
if size(I, 3) == 3
    I = rgb2gray(I);
end
